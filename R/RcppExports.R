...
CD <- function(node, dataSize, data, nlevels, obsIndex_R, eor_nr, eor, lambda_seq, nlam, eps, convLb, qtol, weights, gamma, order, upperbound, threshold) {
    .Call('discretecdAlgorithm_CD', PACKAGE = 'discretecdAlgorithm', node, dataSize, data, nlevels, obsIndex_R, eor_nr, eor, lambda_seq, nlam, eps, convLb, qtol, weights, gamma, order, upperbound, threshold)
}
