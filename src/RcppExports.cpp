...
// CD
List CD(int node, int dataSize, Eigen::Map<Eigen::MatrixXi> data, Eigen::Map<Eigen::VectorXi> nlevels, List obsIndex_R, int eor_nr, Eigen::Map<Eigen::MatrixXi> eor, double fmlam, int nlam, double eps, double convLb, double qtol, Eigen::Map<Eigen::MatrixXd> weights, double gamma, double upperbound);
RcppExport SEXP discretecdAlgorithm_CD(SEXP nodeSEXP, SEXP dataSizeSEXP, SEXP dataSEXP, SEXP nlevelsSEXP, SEXP obsIndex_RSEXP, SEXP eor_nrSEXP, SEXP eorSEXP, SEXP fmlamSEXP, SEXP nlamSEXP, SEXP epsSEXP, SEXP convLbSEXP, SEXP qtolSEXP, SEXP weightsSEXP, SEXP gammaSEXP, SEXP upperboundSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type fmlam(fmlamSEXP);
    ...
    __result = Rcpp::wrap(CD(node, dataSize, data, nlevels, obsIndex_R, eor_nr, eor, fmlam, nlam, eps, convLb, qtol, weights, gamma, upperbound));
    return __result;
END_RCPP
}
