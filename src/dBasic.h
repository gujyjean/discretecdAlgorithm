...
void DatGen(const Eigen::MatrixXi& ordex, const std::vector<int>& ts, const std::vector< std::vector<int> > ivn, const Eigen::VectorXi nlevels, Eigen::MatrixXi& data, const double coef);
