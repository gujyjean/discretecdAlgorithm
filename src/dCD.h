...
void CDAlgo(int node, int dataSize, const Eigen::MatrixXi& data, const Eigen::VectorXi& nlevels, const VectorXVXi& obsIndex, const MatrixXVXi& levelIndex,
			int eor_nr, const Eigen::MatrixXi& eor, double fmlam, int nlam, double eps, double convLb, double qtol, Eigen::VectorXd& lambdaSeq, Eigen::VectorXd& log_like, Eigen::VectorXd& dur,
